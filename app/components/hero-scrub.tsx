...
export default function HeroScrub() {
  ...
  return (
    <section
      id="top"
      ref={sectionRef}
      className="relative h-[520vh] max-[760px]:h-[390vh] motion-reduce:h-screen!"
    >
      <div className="sticky top-0 flex h-screen w-full flex-col overflow-hidden bg-black">
        <div className="relative h-full min-h-0 w-full flex-none overflow-hidden max-[760px]:h-auto max-[760px]:max-h-[64vh] max-[760px]:flex-1">
          <video
            ref={videoRef}
            src="/kold-scroll.mp4"
            muted
